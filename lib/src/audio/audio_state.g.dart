...
AudioState _$AudioStateFromJson(Map<String, dynamic> json) => AudioState(
  ...
  bluetoothRoutes: _bluetoothAudioRoutesFromJson(
    json['bluetoothRoutes'] as List,
  ),
);

Map<String, dynamic> _$AudioStateToJson(
  AudioState instance,
) => <String, dynamic>{
  'currentRoute': instance.currentRoute.toJson(),
  'availableRoutes': instance.availableRoutes.map((e) => e.toJson()).toList(),
  'bluetoothDeviceName': instance.bluetoothDeviceName,
  'isMicrophoneMuted': instance.isMicrophoneMuted,
  'bluetoothRoutes': instance.bluetoothRoutes.map((e) => e.toJson()).toList(),
};
