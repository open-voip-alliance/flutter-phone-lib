...
class _$SupplementaryContactImpl implements _SupplementaryContact {
  const _$SupplementaryContactImpl({required this.number, required this.name});
  ...
  @override
  String toString() {
    return 'SupplementaryContact(number: $number, name: $name)';
  }
...
abstract class _SupplementaryContact implements SupplementaryContact {
  const factory _SupplementaryContact(
      ...
      required final String name}) = _$SupplementaryContactImpl;
