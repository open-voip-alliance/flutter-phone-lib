...
internal class AndroidCallFramework(
   ...
   val isInCall: Boolean
    ...
    companion object {
        // Must remain the APL package name: this id identifies the PhoneAccount
        // registered with the Telecom framework on existing installs.
        private const val PHONE_ACCOUNT_HANDLE_ID = "org.openvoipalliance.androidphoneintegration"
    }
}
